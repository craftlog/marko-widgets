...
exports.writeInitWidgetsCode = function(widgetsContext, out, options) {
    ...
    if (scanDOM) {
        ...
        var widgetsConfig = widgetDef.out.global.widgetsConfig;
        var disableStateSerialization = widgetsConfig ? widgetsConfig.disableStateSerialization : false;

        if (isObjectEmpty(widgetStateStore) || disableStateSerialization) {
        ...
        if (isObjectEmpty(widgetConfigStore) || disableStateSerialization) {
